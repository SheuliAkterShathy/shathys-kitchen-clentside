...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-pink-300">
        <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 mt-12">
            <div className="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                    <div className="flex items-center justify-center w-12 h-12 rounded-full bg-pink-400">
                      
                        <img src="https://png.pngtree.com/png-vector/20220727/ourmid/pngtree-food-logo-png-image_6089719.png" alt="" />
                    </div>
                    <span className="self-center text-2xl font-semibold">Shathy's Kitchen</span>
                </a>
            </div>
        ...
        <div className="py-6 text-sm text-center">© 2022. All rights reserved.</div>
    </footer>
    );
};
