...
const SignUp = () => {
	...
	<h2 className="mb-3 text-3xl font-semibold text-center">Signup your account</h2>
	<p className="text-sm text-center">Do you have account?
		<Link to="/login" rel="noopener noreferrer" className="focus:underline hover:underline text-pink-500">Login here</Link>
	</p>
	...
	<form novalidate="" action="" className="space-y-8 ng-untouched ng-pristine ng-valid">
		<div className="space-y-4">
			<div className="space-y-2">
				...
				<input type="name" name="name" id="" placeholder="Your Name" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
			</div>
			<div className="space-y-2">
				<label for="photoURL" className="block text-sm">photoURL</label>
				<input type="text" name="photoURL" id="" placeholder="photoURL" className="w-full px-3 py-2 border rounded-md border-gray-700 bg-gray-900 text-gray-100 focus:border-violet-400" />
			</div>
			<div className="space-y-2">
		...
		<button type="submit" className="w-full px-8 py-3 font-semibold rounded-md bg-pink-300 text-gray-900">Sign Up</button>
	</form>
</div>
    </div>
    );
